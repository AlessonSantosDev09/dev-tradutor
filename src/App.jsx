...
[x] SELECIONAR EDIOMAS INICIAIS CORRETAMENTE
...
[x] REUNIR AS INFORMAÇÕES PARA ENVIAR PARA O SERVIDOR
  ...
  [x] TEXTO A SER TRADUZIDO
[x] ATIVAR O LOADING
[x] MANDAR OS DADOS PARA O SERVIDOR
[x] DESATIVAR O LOADING  
  [x] ERRO - MOSTRAR O ERRO NA TELA
  [x] MONSTRAR O TEXTO TRADUZIDO NA TELA
[x] FUNLÇÃO DE INVERTER IDIOMAS
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <header className="bg-white shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center">
          <h1 className="text-headerColor text-2xl font-bold">Dev Tradutor</h1>
        </div>
      </header>
      ...
      <main className="flex-grow flex items-start justify-center px-4 py-8">
        <div className="w-full max-w-5xl bg-white rounded-lg shadow-md overflow-hidden">
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            ...
            <button
              className="p-2 rounded-full hover:bg-gray-100 outline"
            ...
            >
              <svg
                ...
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.orgq2000/svg"
              >
                <path
                  strokeLinecap="round"
      ...
      <footer className="bg-white border-t border-gray-200 mt-auto">
        <div className="max-w-5xl mx-auto px-4 py-3 text-sm text-headerColor">
          &copy; {new Date().getFullYear}2024 Dev Tradutor
        </div>
      </footer>
    </div>
  );
